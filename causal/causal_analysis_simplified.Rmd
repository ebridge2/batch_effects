...
age.plt <- plot(single.opt %>%
  ggplot(aes(y=Dataset, x=Age, group=paste0(Dataset, Sex),
    ...
    scale_color_manual(values=c(`1`="blue", `2`="red"), labels=c(`1`="Male", `2`="Female"), name="Sex", aesthetics="point_color") +
    theme_bw() +
...
plt <- (df <- single.opt %>%
  ...
  ggplot(aes(ymin=as.numeric(Dataset), group=paste0(Dataset, Sex),
    ...
    scale_fill_manual(values=c(`1`="blue", `2`="red"), labels=c(`1`="Male", `2`="Female"), name="Sex") +
    scale_color_manual(values=c(`1`="blue", `2`="red"), labels=c(`1`="Male", `2`="Female"), name="Sex", aesthetics="color") +
